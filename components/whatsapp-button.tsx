...
export function WhatsAppButton() {
  const phoneNumber = "923214567890" // Pakistan number without + sign
  const message = encodeURIComponent("Hi! I'm interested in Verdant Electronics products. Can you help me?")
